import svgPaths from "./svg-v6e397mcz6";
...
function Count() {
  return (
    <div className="bg-[#273341] content-stretch flex flex-col items-center justify-center px-[6px] relative rounded-[50px] shrink-0" data-name="Count">
      <p className="font-['Mulish:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[12px] text-center text-white">3</p>
    </div>
  );
}
...
function Group2() {
  return (
    <div className="absolute inset-[0_19.33%_-0.01%_19.33%]" data-name="Group">
...
function Group1() {
  return (
    <div className="absolute contents inset-[0_19.33%_-0.01%_19.33%]" data-name="Group">
      <Group2 />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative" data-name="Title">
      <div className="capitalize flex flex-col font-['Mulish:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[#2d3e50] text-[24px] whitespace-nowrap">
        <p className="leading-[33px]">Imminent Changes</p>
      </div>
    </div>
  );
}
...
function TableLayoutHeading() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-[1110px]" data-name="Table Layout Heading">
      <Title />
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative">
      <p className="font-['Mulish:SemiBold',sans-serif] font-semibold leading-[18px] overflow-hidden relative shrink-0 text-[#2d3e50] text-[14px] text-ellipsis">{`Partner `}</p>
    </div>
  );
}
...
function Container() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-center relative shrink-0 w-[180px]" data-name="Container">
      <p className="font-['Mulish:SemiBold',sans-serif] font-semibold leading-[15px] overflow-hidden relative shrink-0 text-[#2d3e50] text-[12px] text-ellipsis w-full whitespace-nowrap">Partner 1</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-center relative shrink-0 w-[180px]" data-name="Container">
      <p className="font-['Mulish:SemiBold',sans-serif] font-semibold leading-[15px] overflow-hidden relative shrink-0 text-[#2d3e50] text-[12px] text-ellipsis w-full whitespace-nowrap">Partner 2</p>
    </div>
  );
}
...
function Container2() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-center relative shrink-0 w-[180px]" data-name="Container">
      <p className="font-['Mulish:SemiBold',sans-serif] font-semibold leading-[15px] overflow-hidden relative shrink-0 text-[#2d3e50] text-[12px] text-ellipsis w-full whitespace-nowrap">Partner 3</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative">
      <p className="font-['Mulish:SemiBold',sans-serif] font-semibold leading-[18px] overflow-hidden relative shrink-0 text-[#2d3e50] text-[14px] text-ellipsis">Message</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col h-full items-start justify-center relative shrink-0 w-[180px]" data-name="Container">
      <p className="font-['Mulish:Regular',sans-serif] font-normal leading-[15px] overflow-hidden relative shrink-0 text-[#2d3e50] text-[12px] text-ellipsis">Contract active on Oct 01, 2024 00:00 MST</p>
    </div>
  );
}
...
export default function ImminentChanges() {
  return (
    <div className="relative size-full" data-name="Imminent Changes">
      <NavExpanded />
      <Frame2 />
    </div>
  );
