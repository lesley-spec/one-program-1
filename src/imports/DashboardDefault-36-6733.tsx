import svgPaths from "./svg-ubftugqqyw";
...
import { imgTShirt, imgNeck, imgNeck1 } from "./svg-b6dor";
...
function SpaciousStatusFinanceWidget() {
  return (
    <div className="bg-[#d8e2ec] content-stretch flex gap-[8px] h-[40px] items-center pl-[16px] pr-[12px] relative rounded-[9999px] shrink-0" data-name="Spacious Status (finance widget)">
...
function EngageFilled() {
  return (
    <div className="flex-[1_0_0] h-full min-h-px min-w-px relative" data-name="Engage-filled">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Engage-filled">
          <path d={svgPaths.p78afd80} fill="var(--fill-0, #1D66DE)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Icon + Text">
      <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#1d66de] text-[14px]">
        <p className="leading-[18px] whitespace-pre-wrap">Partners</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Icon + Text">
      <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[14px]">
        <p className="leading-[18px] whitespace-pre-wrap">Groups</p>
      </div>
    </div>
  );
}
...
function IconText2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Icon + Text">
      <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[14px]">
        <p className="leading-[18px] whitespace-pre-wrap">Contacts</p>
      </div>
    </div>
  );
}
...
function IconText3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Icon + Text">
      <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[14px]">
        <p className="leading-[18px] whitespace-pre-wrap">Messages</p>
      </div>
    </div>
  );
}
...
function IconText4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Icon + Text">
      <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[14px]">
        <p className="leading-[18px] whitespace-pre-wrap">Applications</p>
      </div>
    </div>
  );
}
...
function Count() {
  return (
    <div className="bg-[#bf1044] content-stretch flex flex-col items-center justify-center min-w-[16px] px-[4px] relative rounded-[50px] shrink-0 size-[16px]" data-name="Count">
      <div className="flex flex-col font-['Sarabun:SemiBold',sans-serif] justify-end leading-[0] not-italic relative shrink-0 text-[10px] text-center text-white whitespace-nowrap">
        <p className="leading-[10px]">1</p>
      </div>
    </div>
  );
}
...
function IconText5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Icon + Text">
      <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[14px]">
        <p className="leading-[18px] whitespace-pre-wrap">Proposals Sent</p>
      </div>
    </div>
  );
}
...
function IconText6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative" data-name="Icon + Text">
      <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[14px]">
        <p className="leading-[18px] whitespace-pre-wrap">Surveys</p>
      </div>
    </div>
  );
}

function VNextSecondary6() {
  return (
    <div className="bg-[#f9fbff] h-[32px] relative rounded-[9999px] shrink-0 w-full" data-name="VNext Secondary">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[32px] pr-[8px] py-[2px] relative size-full">
...
function SecondaryMenu() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Secondary Menu">
      <VNextSecondary />
      <VNextSecondary1 />
      <VNextSecondary2 />
      <VNextSecondary3 />
...
function Partners() {
  return (
    <div className="content-stretch flex flex-col gap-[5px] items-start relative shrink-0 w-full" data-name="Partners">
      <VNextPrimary1 />
      <SecondaryMenu />
    </div>
  );
...
function NavExpanded() {
  return (
    <div className="absolute bg-[#edf1f9] bottom-[-1px] left-[-1px] top-[-1px] w-[1440px]" data-name="Nav Expanded">
      <VNextDesktopTopNav />
      <VNextSideNav />
    </div>
  );
...
function SecondaryButton() {
  return (
    <div className="bg-[#f0f1f3] content-stretch flex gap-[8px] h-[32px] items-center justify-center min-w-[65px] px-[16px] relative rounded-[9999px] shrink-0" data-name="Secondary Button">
    ...
    <div className="absolute inset-[0_10.14%]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 12.7538 16">
        <g id="Group 4941">
          ...
          <path d={svgPaths.p2ba2b000} fill="var(--fill-0, #102A46)" id="Vector_2" />
          <path d={svgPaths.pb548230} fill="var(--fill-0, #102A46)" id="Vector_3" />
...
function TertiaryButton() {
  return (
    <div className="bg-[rgba(255,255,255,0)] content-stretch flex gap-[8px] h-[32px] items-center justify-center min-w-[65px] px-[16px] relative rounded-[9999px] shrink-0" data-name="Tertiary Button">
      <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[14px] text-center">
  ...
  return (
    <div className="bg-white h-[32px] relative rounded-[8px] shrink-0" data-name="Chart Type Toggle">
      <div className="content-stretch flex h-full items-center overflow-clip relative rounded-[inherit]">
        <ChartTypeTab />
        <div className="flex h-[32px] items-center justify-center relative shrink-0 w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "153.5" } as React.CSSProperties}>
  ...
  return (
    <div className="absolute inset-1/4" data-name="Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 8">
        <g id="Check">
          <path clipRule="evenodd" d={svgPaths.p566ac00} fill="url(#paint0_linear_36_6739)" fillRule="evenodd" id="Union" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_36_6739" x1="2.8" x2="7.06724" y1="7.3" y2="-1.29416">
    ...
    <div className="absolute contents inset-[34.64%_51.44%_41.94%_15.8%]" data-name="t-shirt">
      <div className="absolute flex inset-[34.64%_51.44%_41.94%_15.8%] items-center justify-center">
        <div className="flex-none h-[28.773px] skew-x-[0.1deg] w-[45.152px]">
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-5.459px_-21.528px] mask-size-[52.837px_49.34px] relative size-full" data-name="T-Shirt" style={{ maskImage: `url('${imgTShirt}')` }}>
      ...
      <div className="absolute flex inset-[41.38%_56.1%_44.57%_42.01%] items-center justify-center">
        <div className="flex-none h-[17.272px] skew-x-[0.1deg] w-[2.582px]">
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-41.625px_-29.823px] mask-size-[52.837px_49.34px] relative size-full" data-name="Fill 15" style={{ maskImage: `url('${imgTShirt}')` }}>
      ...
      <div className="absolute flex inset-[42.82%_73.56%_44.91%_24.07%] items-center justify-center">
        <div className="flex-none h-[15.088px] skew-x-[0.1deg] w-[3.243px]">
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-16.866px_-31.593px] mask-size-[52.837px_49.34px] relative size-full" data-name="Fill 17" style={{ maskImage: `url('${imgTShirt}')` }}>
...
function HeadLongHairHat() {
  return (
    <div className="absolute contents inset-[2.11%_49.97%_56.35%_2.48%]" data-name="Head/Long Hair Hat">
      ...
      <div className="absolute inset-[2.73%_49.97%_74.92%_14.88%]" data-name="Fill 1">
    ...
    <div className="absolute contents inset-[2.11%_41.91%_34.41%_2.48%]">
      <div className="absolute inset-[8.77%_46.13%_43.96%_8.23%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.9765 58.1359">
          <path d={svgPaths.p28419e00} id="Ellipse 1335" stroke="url(#paint0_linear_36_6745)" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_36_6745" x1="0" x2="62.9765" y1="29.0679" y2="29.0679">
    ...
    <div className="absolute contents inset-[79.8%_21.77%_2.3%_50.67%]" data-name="t-shirt">
      ...
      <div className="absolute flex inset-[85.6%_43.84%_2.49%_54.56%] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[14.645px] rotate-180 w-[2.2px]">
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-6.643px_-30.21px] mask-size-[40.837px_38.134px] relative size-full" data-name="Fill 15" style={{ maskImage: `url('${imgNeck}')` }}>
      ...
      <div className="absolute flex inset-[86.81%_28.63%_2.79%_69.37%] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[12.793px] rotate-180 w-[2.759px]">
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-27.079px_-31.69px] mask-size-[40.837px_38.134px] relative size-full" data-name="Fill 17" style={{ maskImage: `url('${imgNeck}')` }}>
    ...
    <div className="absolute contents inset-[54.81%_18.21%_7.96%_46.52%]">
      <div className="absolute inset-[54.81%_18.21%_8.66%_46.52%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48.6738 44.9325">
          <path d={svgPaths.pb201660} id="Ellipse 1336" stroke="url(#paint0_linear_36_6737)" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_36_6737" x1="0" x2="48.6738" y1="22.4663" y2="22.4663">
    ...
    <div className="absolute contents inset-[36.3%_13.59%_52.29%_71.48%]" data-name="t-shirt">
      <div className="absolute flex inset-[36.3%_13.59%_52.29%_71.48%] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[14.035px] rotate-180 w-[20.613px]">
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-7px_-23.495px] mask-size-[33.264px_31.063px] relative size-full" data-name="T-Shirt" style={{ maskImage: `url('${imgNeck1}')` }}>
      ...
      <div className="absolute flex inset-[40%_27.15%_52.41%_71.87%] items-center justify-center">
      ...
      <div className="absolute flex inset-[40.76%_17.8%_52.61%_80.97%] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[8.156px] rotate-180 w-[1.697px]">
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-20.101px_-28.987px] mask-size-[33.264px_31.063px] relative size-full" data-name="Fill 17" style={{ maskImage: `url('${imgNeck1}')` }}>
    ...
    <div className="absolute contents inset-[31.8%_13.59%_52.29%_71.48%]" data-name="Master/Character/Avatar [colors]">
      <div className="absolute flex inset-[31.8%_17.06%_60.36%_73.78%] items-center justify-center">
        <div className="-scale-y-100 flex-none h-[9.638px] rotate-180 w-[12.643px]">
          <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[-10.177px_-17.966px] mask-size-[33.264px_31.063px] relative size-full" data-name="neck" style={{ maskImage: `url('${imgNeck1}')` }}>
...
function HeadPonytailDark() {
  return (
    <div className="absolute contents inset-[14.42%_13.79%_64.67%_71.28%]" data-name="Head/Ponytail Dark">
      ...
      <div className="absolute flex inset-[14.42%_13.79%_69.86%_71.28%] items-center justify-center">
      ...
      <div className="absolute flex inset-[18.34%_19.99%_79.89%_77.25%] items-center justify-center">
      ...
      <div className="absolute flex inset-[29%_18.66%_69.78%_80.18%] items-center justify-center">
...
function TertiaryIconButton6() {
  return (
    <div className="absolute content-stretch flex gap-[8px] h-[32px] items-center justify-center max-w-[32px] min-w-[32px] px-[16px] right-[14px] rounded-[9999px] top-[65.5px]" data-name="Tertiary Icon Button">
      <IconContainer26 />
    </div>
  );
}
...
function Frame47() {
  return (
    <div className="-translate-y-1/2 absolute bg-white content-stretch flex flex-col h-[1406px] items-center right-[-1px] top-[calc(50%+35px)] w-[1118px]">
      <Frame34 />
    </div>
  );
}
...
export default function DashboardDefault() {
  return (
    <div className="bg-white border border-[#cacfd3] border-solid overflow-clip relative rounded-[8px] size-full" data-name="Dashboard - Default">
      <NavExpanded />
      <Frame47 />
    </div>
  );
