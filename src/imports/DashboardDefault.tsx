import svgPaths from "./svg-w751u6a6wp";
...
import { imgTShirt, imgNeck, imgNeck1 } from "./svg-181gr";
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[16px] pr-[8px] py-[6px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[16px]">
            <p className="leading-[20px] whitespace-pre-wrap">Overview</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f9fbff] h-[40px] relative rounded-[9999px] shrink-0 w-full" data-name="VNext Primary">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[16px] pr-[8px] py-[6px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[16px]">
            <p className="leading-[20px] whitespace-pre-wrap">Make Deposit</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f9fbff] h-[40px] relative rounded-[9999px] shrink-0 w-full" data-name="VNext Primary">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[16px] pr-[8px] py-[6px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[16px]">
            <p className="leading-[20px] whitespace-pre-wrap">Transfers</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f9fbff] h-[40px] relative rounded-[9999px] shrink-0 w-full" data-name="VNext Primary">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[16px] pr-[8px] py-[6px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[16px]">
            <p className="leading-[20px] whitespace-pre-wrap">Documents</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f9fbff] h-[40px] relative rounded-[9999px] shrink-0 w-full" data-name="VNext Primary">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center pl-[16px] pr-[8px] py-[6px] relative size-full">
          <div className="flex flex-[1_0_0] flex-col font-['Sarabun:SemiBold',sans-serif] justify-center leading-[0] min-h-px min-w-px not-italic relative text-[#25282f] text-[16px]">
            <p className="leading-[20px] whitespace-pre-wrap">Subscription</p>
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="absolute inset-1/4" data-name="Check">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8 8">
        <g id="Check">
          <path clipRule="evenodd" d={svgPaths.p566ac00} fill="url(#paint0_linear_21_6787)" fillRule="evenodd" id="Union" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_21_6787" x1="2.8" x2="7.06724" y1="7.3" y2="-1.29416">
    ...
    <div className="absolute contents inset-[2.11%_41.91%_34.41%_2.48%]">
      <div className="absolute inset-[8.77%_46.13%_43.96%_8.23%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 62.9765 58.1359">
          <path d={svgPaths.p28419e00} id="Ellipse 1335" stroke="url(#paint0_linear_21_6706)" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_21_6706" x1="0" x2="62.9765" y1="29.0679" y2="29.0679">
    ...
    <div className="absolute contents inset-[54.81%_18.21%_7.96%_46.52%]">
      <div className="absolute inset-[54.81%_18.21%_8.66%_46.52%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48.6738 44.9325">
          <path d={svgPaths.pb201660} id="Ellipse 1336" stroke="url(#paint0_linear_21_6792)" />
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_21_6792" x1="0" x2="48.6738" y1="22.4663" y2="22.4663">
